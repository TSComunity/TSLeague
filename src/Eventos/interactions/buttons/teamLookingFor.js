    ...
    async execute(interaction) {
        try {
            ...
            const statusText = newStatus
                ? `Se ha activado tu estado de free agent, se ha enviado un mensaje a <#${configs.channels.freeAgents.id}> con información actualizada cada 15 minutos de tu perfil de Brawl Stars.`
                : `Se ha desactivado tu estado de free agent, tu mensaje buscando equipo de <@${configs.channels.freeAgents.id}> ha sido eliminado.`
